...
!(function r(a, s, l) {
	...
	for (
		var u = "function" == typeof require && require, e = 0; e < l.length; e++
	)
		d(l[e]);
	return d;
})({
									...
									function(e) {
										if (
											...
											g.paused || (g.pause(), (g.forcedHandlePause = !0)),
												...
												i(e);
											for (
												var t = ["mouseup", "touchend"], n = 0, o = t.length; n < o; n++
											)
				...
				Object.assign(o.config, {
					...
					Object.assign(i.default.prototype, {
						...
						searchTrackPosition: function(e, t) {
							for (
								var n = 0, o = e.length - 1, i = void 0, r = void 0, a = void 0; n <= o;
							...
							parse: function(e) {
								for (
									...
									if ((o = this.pattern.exec(t[a])) && a < t.length) {
										...
										n.push({
											identifier: r,
											start: 0 === (0, m.convertSMPTEtoSeconds)(o[1]) ?
												0.2 : (0, m.convertSMPTEtoSeconds)(o[1]),
						...
						o(r, [{
							...
							},
							{
								...
								value: function(e, n) {
									...
									if ((e = (0, m.splitEvents)(e, this.id)).d)
										for (
											var t = e.d.split(" "), i = 0, r = t.length; i < r; i++
										)
									...
									if (e.w)
										for (
											var a = e.w.split(" "), s = 0, l = a.length; s < l; s++
										)
							...
							},
							{
								...
								value: function(e, t, n, o) {
									for (
										var i = 0, r = this.options.features.length; i < r; i++
									) {
						...
						create: function(s, l, e) {
							...
							if (
								((S.default["__ready__" + r] = function(e) {
										s.dashPlayer = u = e;
										for (
											var t, n = dashjs.MediaPlayer.events, o = 0, i = f.length; o < i; o++
										)
			...
			function(e, t, n) {
				...
				var k = {
						...
						iFrameReady: function() {
							for (
								k.isLoaded = !0, k.isIframeLoaded = !0; 0 < k.iframeQueue.length;
						...
						getYouTubeIdFromParam: function(e) {
							...
							for (
								var t = e.split("?")[1].split("&"), n = "", o = 0, i = t.length; o < i; o++
							) {
								var r = t[o].split("=");
								if ("v" === r[0]) {
									n = r[1];
			...
			function(e, t, n) {
				...
				if (
					([
							...
							function(e) {
								for (
									var t = (
										...
										n = t.length - 1; 0 <= --n && t.item(n) !== this;
						...
						(function() {
							for (
								var i = 0, e = ["ms", "moz", "webkit", "o"], t = 0; t < e.length && !window.requestAnimationFrame;
								++t
							)
				...
				function d(e) {
					...
					for (
						var t = ~(e = e.replace(",", ".")).indexOf(".") ?
							...
							o = 1,
							i = 0,
							r = (e = e.split(":").reverse()).length; i < r; i++
					)
