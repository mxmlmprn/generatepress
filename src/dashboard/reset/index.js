...
const Reset = () => {
	...
	return ( <
		...
		<
		h2 > {
			__('Reset', 'generatepress')
		} < /h2> <
		/div>

		<
		div className = "generatepress-dashboard__section-item-description"
		style = {
			{
				marginTop: 0
			}
		...
		<
		Button className = "generatepress-dashboard__reset-button"
		style = {
			{
				marginTop: '10px',
			}
		...
		<
		span className = "generatepress-dashboard__section-item-message"
		style = {
			{
				marginLeft: '10px'
			}
