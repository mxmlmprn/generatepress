...
const GoPro = () => {
		...
		return ( <
			> {
				...
				<
				h2 > {
					__('GeneratePress Premium', 'generatepress')
				} < /h2> <
				/div>
				...
				div className = "generatepress-dashboard__section generatepress-dashboard__premium" > {
					Object.keys(proItems).map((item, index) => {
							...
							return ( <
								div className = "generatepress-dashboard__premium-item"
								key = {
									index
								} >
								<
								...
								{
									!!proItems[item].description && < div className = "generatepress-dashboard__premium-item-description" > {
											proItems[item].description
										} < /div> } <
										/div>
