...
const MarginBottom = ({
	...
	return ( <
		...
		step = {
			getRangeProps(font, 'marginBottom', 'step', .1)
		}
		rangeMin = {
			getRangeProps(font, 'marginBottom', 'min', 0)
		}
		rangeMax = {
			getRangeProps(font, 'marginBottom', 'max', 5)
		}
		inputMin = {
			0
		}
		...
		desktopInitial = {
			getPlaceholder(font, 'marginBottom')
		}
		desktopOnChange = {
			(newValue) => {
				if (0 > newValue) {
		...
		tabletValue = {
			font.marginBottomTablet
		}
		tabletInitial = {
			getPlaceholder(font, 'marginBottomTablet')
		}
		tabletOnChange = {
			(newValue) => {
				if (0 > newValue) {
		...
		mobileValue = {
			font.marginBottomMobile
		}
		mobileInitial = {
			getPlaceholder(font, 'marginBottomMobile')
		}
		mobileOnChange = {
			(newValue) => {
				if (0 > newValue) {
